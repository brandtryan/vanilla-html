...
export const happyAccidentFrames = [{ fontVariationSettings: `"wght" 295, "wdth" 100, "ital" 0, "cont" 100` }, { fontVariationSettings: `"wght" 900, "wdth" 100, "ital" 0, "cont" 100` }];

export const happyAccidentTiming = [
	{
		// id: "",
		delay: 100,
		direction: 'alternate',
...
// export const bellyWaveWDTH = wrdBellyWave.animate(
// 	[
...
// export const bellyWaveITAL = wrdBellyWave.animate(
// 	[
// 		{ fontVariationSettings: `"wght" 295, "wdth" 100, "ital" 0, "cont" 100` },
...
// export const bellyWaveCONT = wrdBellyWave.animate(
// 	[
// 		{ fontVariationSettings: `"wght" 295, "wdth" 100, "ital" 0, "cont" 100` },
